...
amostras.y = np.log(amostras.y)
amostras.desvio_y = np.abs(np.log(amostras.desvio_y))
...
definicoes = {
    ...
    "x_label": "t (s)",
    "y_label": "$ln(ddp (V))$",
    "a_legend": "$a = -0,0553 \\pm 0,0009$",
    "b_legend": "$b = 3,95 \\pm 0,01$",
    "text_size" : 6,
    "text_offset_x" : 0,
    "text_offset_y" : 0,
}
...
# print(amostras)
calcula_grafo.gera_imagem(amostras, "exercicio 4.3", definicoes)
